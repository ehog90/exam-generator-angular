...
export class PersistenceService {
  ...
  constructor() {
    ...
    this.changes.pipe(bufferTime(100)).subscribe((x) => this.saveValues(x));
  }
  ...
  public addToArray(namespace: string, key: string, value: string | number) {
    this.changes.next({
      ...
      value: value,
      namespace: namespace,
      itemType: ItemChangeType.AddToArray
    });
  }
  ...
  public removeFromArray(
    ...
    this.changes.next({
      ...
      value: value,
      namespace: namespace,
      itemType: ItemChangeType.RemoveFromArray
    });
  }
  ...
  public setString(namespace: string, key: string, value: string) {
    this.changes.next({
      ...
      value: value,
      namespace: namespace,
      itemType: ItemChangeType.String
    });
  }
